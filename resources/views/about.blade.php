...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <script href="./assets/js/jquery-3.2.1.min.js"></script>
    <script href="./assets/js/popper.js"></script>
    <script href="./assets/js/bootstrap.min.js"></script>
    <script href="./assets/js/stellar.js"></script>
    <script href="./assets/js/jquery.magnific-popup.min.js"></script>
    <script href="./assets/vendors/nice-select/js/jquery.nice-select.min.js"></script>
    <script href="./assets/vendors/isotope/imagesloaded.pkgd.min.js"></script>
    <script href="./assets/vendors/isotope/isotope-min.js"></script>
    <script href="./assets/vendors/owl-carousel/owl.carousel.min.js"></script>
    <script href="./assets/js/jquery.ajaxchimp.min.js"></script>
    <script href="./assets/js/mail-script.js"></script>
    <!--gmaps Js-->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCjCGmQ0Uq4exrzdcL6rvxywDDOvfAu6eE"></script>
    <script href="./assets/js/gmaps.min.js"></script>
